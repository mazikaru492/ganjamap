      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 p-6">
        ...
        <div className="flex rounded-lg border border-gray-200 p-1 mb-5">
          <button
            ...
            className={`flex-1 py-1.5 text-sm font-medium rounded-md transition-colors ${
              mode === 'login' ? 'bg-green-600 text-white' : 'text-gray-600'
            }`}
          >
            ログイン
          </button>
          <button
            ...
            className={`flex-1 py-1.5 text-sm font-medium rounded-md transition-colors ${
              mode === 'signup' ? 'bg-green-600 text-white' : 'text-gray-600'
            }`}
          >
            新規登録
          </button>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-10 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg text-sm transition-colors disabled:opacity-50"
          >
        ...
        <button
          ...
          className="w-full h-10 flex items-center justify-center gap-2 border border-gray-300 rounded-lg text-sm text-gray-700 hover:bg-gray-50 transition-colors"
        >
